...
function App() {
    ...
    const toggleShow = function(){
        const innerFabs = document.querySelector('.inner-fabs');
                ...
                <div class="options-input">
                    <div class="fabs-container">
                        <div class="inner-fabs">
                            <div class="fab" id="fab3" data-tooltip="Chatting">
                                <svg viewBox="0 0 24 24" fill="none" width="28px" height="28px" stroke="#fff" stroke-width="0.4">
                                    ...
                                    <path d="M8 11H8.009M11.991 11H12M15.991 11H16" stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"></path>
                                </svg>
                            </div>
                            <div class="fab" id="fab2" data-tooltip="Spelling">
                                <svg viewBox="0 0 32 32" fill="#fff" width="24px" height="24px" stroke="#fff" stroke-width="0.6">
                            ...
                            <div class="fab" id="fab1" data-tooltip="Translation">
                                <svg viewBox="0 0 24 24" fill="none" width="30px" height="30px">
                        ...
                        <div onClick={toggleShow} class="fab fab0" id="fab0">
                            <svg viewBox="0 0 24 24" fill="none" width="30px" height="30px">
